...
public class Community {
	...
	//var comm_nodeList_Total:ArrayList[int];
	...
	public def this(filename:String, type_file:int, passTimes:int, precision:double)
	{
		...
		//comm_nodeList_Total = new ArrayList[int](size+1);
	...
	public def one_level( level:int )
	{
		...
		do{
			...
			var endInit:Long = timer.milliTime();
	        ...
	        var endCommunication:Long = timer.milliTime();
