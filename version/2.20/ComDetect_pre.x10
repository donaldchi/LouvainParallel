...
public class ComDetect_pre 
{
	...
	public static def main(args:Array[String]) 
	{
        ...
        var cd:ComDetect_pre = new ComDetect_pre(); 
        cd.checkArgs(args);
        ...
        var com:Community_pre = new Community_pre(cd.filename, cd.type_file, cd.passTimes, cd.precision);
	...
	Console.OUT.println("PlaceNum::"+Place.ALL_PLACES);
        ...
        //do{
            ...
            com = new Community_pre(g, -1, cd.precision, com.inside_tmp);
